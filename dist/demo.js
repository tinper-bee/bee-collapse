	...
	var Demo1 = function (_Component) {
		...
		Demo1.prototype.render = function render() {
			...
			return _react2['default'].createElement(
				...
				_react2['default'].createElement(
					_beeButton2['default'],
					{ colors: 'success', onClick: function onClick() {
							return _this2.setState({ open: !_this2.state.open });
						} },
					'unmountOnExit\u4E3Atrue\u7684Demo'
				),
				_react2['default'].createElement(
					_src2['default'],
					{ 'in': this.state.open, unmountOnExit: true },
					_react2['default'].createElement(
						'div',
						null,
						'\u6211\u662F\u6298\u53E0\u533A\u57DF\u7684\u5185\u5BB9\uFF0C\u70B9\u51FB\u6309\u94AE\u6211\u5C31\u663E\u793A\uFF0C\u518D\u6B21\u70B9\u51FB\u5C31\u4F1A\u9690\u85CF\u3002unmountOnExit\u4E3Atrue\u9690\u85CF\u65F6\u6211\u8FD9\u4E2Adom\u5C06\u88AB\u79FB\u9664\u3002'
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Demo1 = function (_Component) {
		...
		Demo1.prototype.onEnter = function onEnter() {
	
			document.getElementById('desc').innerHTML = "内容将要显示";
		};
	
		Demo1.prototype.onEntering = function onEntering() {
	
			document.getElementById('desc').innerHTML = "内容正在显示";
		};
	
		Demo1.prototype.onEntered = function onEntered() {
			document.getElementById('desc').innerHTML = "内容已显示完成";
		};
		...
		Demo1.prototype.render = function render() {
			...
			return _react2['default'].createElement(
				...
				_react2['default'].createElement(
					_src2['default'],
					{ 'in': this.state.open, onEnter: this.onEnter, onEntering: this.onEntering, onEntered: this.onEntered },
					_react2['default'].createElement(
						'div',
						null,
						'\u6211\u662F\u6298\u53E0\u533A\u57DF\u7684\u5185\u5BB9\uFF0C\u70B9\u51FB\u6309\u94AE\u6211\u5C31\u663E\u793A\uFF0C\u518D\u6B21\u70B9\u51FB\u5C31\u4F1A\u9690\u85CF\u3002\u5FEB\u6765\u70B9\u51FB\u6309\u94AE\u4F53\u9A8C\u6211\u7684\u4EA4\u4E92\u6548\u679C\u5427\uFF0C\u662F\u4E0D\u662F\u5F88\u68D2\uFF01\u8D76\u5FEB\u4F7F\u7528\u5427~~~'
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Demo1 = function (_Component) {
		...
		Demo1.prototype.onExit = function onExit() {
			document.getElementById('desc4').innerHTML = "我将要隐藏";
		};
	
		Demo1.prototype.onExiting = function onExiting() {
			document.getElementById('desc4').innerHTML = "我正在隐藏";
		};
	
		Demo1.prototype.onExited = function onExited() {
			document.getElementById('desc4').innerHTML = "我已隐藏完成";
		};
		...
		Demo1.prototype.render = function render() {
			...
			return _react2['default'].createElement(
				...
				_react2['default'].createElement(
					_src2['default'],
					{ 'in': this.state.open, onExit: this.onExit, onExiting: this.onExiting, onExited: this.onExited },
					_react2['default'].createElement(
						'div',
						null,
						'\u6211\u662F\u6298\u53E0\u533A\u57DF\u7684\u5185\u5BB9\uFF0C\u70B9\u51FB\u6309\u94AE\u6211\u5C31\u663E\u793A\uFF0C\u518D\u6B21\u70B9\u51FB\u5C31\u4F1A\u9690\u85CF\u3002\u5FEB\u6765\u70B9\u51FB\u6309\u94AE\u4F53\u9A8C\u6211\u7684\u4EA4\u4E92\u6548\u679C\u5427\uFF0C\u662F\u4E0D\u662F\u5F88\u68D2\uFF01\u8D76\u5FEB\u4F7F\u7528\u5427~~~'
	...
	var Demo1 = function (_Component) {
		...
		Demo1.prototype.render = function render() {
			...
			return _react2['default'].createElement(
				...
				_react2['default'].createElement(
					_src2['default'],
					{ 'in': this.state.open, dimension: 'width' },
					_react2['default'].createElement(
						'div',
						null,
						'\u6211\u662F\u6298\u53E0\u533A\u57DF\u7684\u5185\u5BB9\uFF0C\u70B9\u51FB\u6309\u94AE\u6211\u5C31\u663E\u793A\uFF0C\u518D\u6B21\u70B9\u51FB\u5C31\u4F1A\u9690\u85CF\u3002\u5FEB\u6765\u70B9\u51FB\u6309\u94AE\u4F53\u9A8C\u6211\u7684\u4EA4\u4E92\u6548\u679C\u5427\uFF0C\u662F\u4E0D\u662F\u5F88\u68D2\uFF01\u8D76\u5FEB\u4F7F\u7528\u5427~~~',
